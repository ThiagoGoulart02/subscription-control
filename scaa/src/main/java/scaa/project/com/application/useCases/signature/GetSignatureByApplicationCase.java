...
@Component
public class GetSignatureByApplicationCase {


    @Autowired
    private SignatureService service;

    public ResponseEntity<List<SignatureResponseDTO>> getSignatureApplicationCase(Long id) {
        return service.getSignatureByApplication(id);
    }
}